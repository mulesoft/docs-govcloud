...
MuleSoft Government Cloud supports Java 17. For more information on Java support, see xref:general::java-support.adoc[].
...
include::access-management::partial$gov-cloud-note.adoc[tag=govcloud]
...
|xref:monitoring::index.adoc[Anypoint Monitoring] |Aggregate and map metrics across systems, and configure dashboards and alerts.
